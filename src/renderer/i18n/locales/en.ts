export default {
  translation: {
    common: { reset: 'Reset' },
    settings: {
      title: 'Settings', language: 'Language', serverMode: 'Server Mode',
    ...
    firstRun: { welcome: 'Welcome to Invoke.', installOrSelect: 'Install or select an existing installation to manage.', selectExisting: 'Select an existing installation', install: 'Install' },
    launchFlow: {
      welcomeBack: 'Welcome back.', usingPrefix: 'Using', usingAt: 'installation at', switchInstallation: 'Switch installation', manage: 'Manage', launch: 'Launch',
      windowCrashed: 'Window Crashed', windowCrashedHelper: 'The Invoke UI window closed unexpectedly, but the server is still running.', windowCrashedAction: 'You can reopen the window or shutdown the server.',
      back: 'Back', restarting: 'Restarting', restartWindow: 'Restart Window', shutdown: 'Shutdown', shuttingDown: 'Shutting down', reopenWindow: 'Reopen Window', shutdownServer: 'Shutdown Server',
      cannotFindInstall: 'Cannot find installation.', noInstallFoundAt: 'No Invoke installation found at', install: 'Install', runningAt: 'Running at {{loopbackUrl}}',
      unableToCheckForUpdates: 'Unable to check for updates.', checkingForUpdates: 'Checking for updates', updateAvailablePrefix: 'Invoke', updateAvailableSuffix: 'is available! Click here to update.', upToDate: 'Up to date.',
      status: { uninitialized: 'Uninitialized', starting: 'Starting', exiting: 'Exiting', exited: 'Exited', windowCrashed: 'Window Crashed' },
    },
    installFlow: {
      steps: {
        location: 'Location',
      ...
      gpu: { nvidiaOld: 'Nvidia (20xx and below)', nvidiaNew: 'Nvidia (30xx and above)', amd: 'AMD', intel: 'Intel Arc (XPU)', noGpu: 'No dedicated GPU' },
      gpuLabel: { nvidiaOld: 'a Nvidia 20xx or older GPU', nvidiaNew: 'a Nvidia 30xx or newer GPU', amd: 'an AMD GPU', intel: 'an Intel Arc GPU', noGpu: 'no GPU' },
      common: { back: 'Back', next: 'Next', cancel: 'Cancel', install: 'Install', finish: 'Finish', canceling: 'Canceling' },
      location: {
    ...
    console: {
      open: 'Open Terminal',
      notStarted: { start: 'Start Dev Console', activatePrefix: 'We will activate the virtual environment for the install at', activateSuffix: '.' },
      running: { title: 'Dev Console', kill: 'Kill Console', restart: 'Restart Console', hide: 'Hide Console' },
    },
    errorBoundary: { title: 'An error occurred.', error: 'Error', unknownError: 'An unknown error occurred.' },
  },
};
